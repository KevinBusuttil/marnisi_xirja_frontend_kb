...
class Lang {
  ...
  String get requestNewPasswordBtn {
    return Intl.message(
      'Request Reset Password',
      name: 'requestNewPasswordBtn',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Register a new account`
  String get requestPasswordTitleBox {
    return Intl.message(
      'Request Reset Password',
      name: 'requestPasswordTitleBox',
      desc: '',
      args: [],
    );
  }
