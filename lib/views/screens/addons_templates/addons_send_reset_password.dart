...
//   Future<void> _doResetPasswordAsync({
...
//         const path = ApiRoutes.resetPassword;
...
//         if (statusKey == 1) {
//           onSuccess.call(message ?? 'User registered successfully. Please login.');
//         } else {
...
//   // method to show a dialog when the password reset is successful
...
//   // method to show a dialog when user not found
...
//                                       ? null
//                                       : () => _doResetPasswordAsync(
//                                             userDataProvider: context.read<UserDataProvider>(),
//                                             onSuccess: (message) => _onSuccess(context, message),
//                                             onError: (message) => _onError(context, message),
//                                           )),
//                                   child: Text(lang.requestNewPasswordBtn),
//                                 ),
//                               ),
//                             ),
//                             SizedBox(
