                    ...
                    child: Column(
                      ...
                      children: [
                        Wrap(
                          ...
                          children: [
                            _chip('A', 'Aaron', themeData.scaffoldBackgroundColor, appColorScheme.primary,
                                themeData.colorScheme.onSurface),
                            _chip('B', 'Bob', themeData.scaffoldBackgroundColor, appColorScheme.secondary,
                                themeData.colorScheme.onSurface),
                            _chip('C', 'Connor', themeData.scaffoldBackgroundColor, appColorScheme.error,
                                themeData.colorScheme.onSurface),
                            _chip('D', 'Darren', themeData.scaffoldBackgroundColor, appColorScheme.success,
                                themeData.colorScheme.onSurface),
                            _chip('E', 'Evan', themeData.scaffoldBackgroundColor, appColorScheme.info,
                                themeData.colorScheme.onSurface),
                            _chip('F', 'Finn', themeData.scaffoldBackgroundColor, appColorScheme.warning,
                                themeData.colorScheme.onSurface),
                          ],
                        ),
                        ...
                        Wrap(
                          ...
                          runSpacing: kDefaultPadding,
                          children: [
                            _chip('A', 'Aaron', appColorScheme.primary, themeData.scaffoldBackgroundColor,
                                themeData.colorScheme.onPrimary),
                            _chip('B', 'Bob', appColorScheme.secondary, themeData.scaffoldBackgroundColor,
                                themeData.colorScheme.onPrimary),
                            _chip('C', 'Connor', appColorScheme.error, themeData.scaffoldBackgroundColor,
                                themeData.colorScheme.onPrimary),
                            _chip('D', 'Darren', appColorScheme.success, themeData.scaffoldBackgroundColor,
                                themeData.colorScheme.onPrimary),
                            _chip('E', 'Evan', appColorScheme.info, themeData.scaffoldBackgroundColor,
                                themeData.colorScheme.onPrimary),
                            _chip('F', 'Finn', appColorScheme.warning, themeData.scaffoldBackgroundColor,
                                themeData.colorScheme.onPrimary),
                          ],
                        ),
                      ],
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _mouseRegion(
                                context, 'SystemMouseCursors.resizeDownLeft', SystemMouseCursors.resizeDownLeft),
                            _mouseRegion(
                                context, 'SystemMouseCursors.resizeDownRight', SystemMouseCursors.resizeDownRight),
                            _mouseRegion(context, 'SystemMouseCursors.resizeLeft', SystemMouseCursors.resizeLeft),
                            _mouseRegion(
                                context, 'SystemMouseCursors.resizeLeftRight', SystemMouseCursors.resizeLeftRight),
                            ...
                            _mouseRegion(context, 'SystemMouseCursors.resizeUpLeftDownRight',
                                SystemMouseCursors.resizeUpLeftDownRight),
                            _mouseRegion(context, 'SystemMouseCursors.resizeUpRight', SystemMouseCursors.resizeUpRight),
                            _mouseRegion(context, 'SystemMouseCursors.resizeUpRightDownLeft',
